...
//	}
	...
	public Docket setSwaggerConfig(){
		...
		return new Docket(DocumentationType.SWAGGER_2).select().paths(PathSelectors.ant("/washers/**")).apis(RequestHandlerSelectors.basePackage("com.cw.washer")).build()
				.apiInfo(apiDetails());
	}
